        ...
        <div className="link-logo-holder">
          ...
          <div className="llh-actual">
            ...
            <a
              ...
              rel="noreferrer"
            >
              <FontAwesomeIcon className="a-tag-links" icon={faInstagram} />
            </a>
            <a
              ...
              rel="noreferrer"
            >
              <FontAwesomeIcon className="a-tag-links" icon={faTiktok} />
            </a>
          </div>
        </div>
      </div>
